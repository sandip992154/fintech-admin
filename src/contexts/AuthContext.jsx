    ...
    try {
      ...
      if (!import.meta.env.VITE_API_BASE_URL || import.meta.env.VITE_API_BASE_URL === 'https://api.mydomain.com') {
        ...
        const simulatedRoles = [
          ...
          { id: 2, name: 'Super Admin', slug: 'super_admin', description: 'Super administrator role' }
        ];
        
        const simulatedPermissions = [
          { id: 1, name: 'Manage Users', slug: 'manage_users', description: 'Can create, edit, and delete users' },
          { id: 2, name: 'View Reports', slug: 'view_reports', description: 'Can access reporting features' },
          { id: 3, name: 'Manage Billing', slug: 'manage_billing', description: 'Can manage billing operations' },
          { id: 4, name: 'System Settings', slug: 'system_settings', description: 'Can modify system settings' }
        ];
